...
%fprintf('Theta4 computed from gradient descent: \n');
%fprintf(' %f \n', theta4);
%fprintf('\n');

%fprintf('Theta5 computed from gradient descent: \n');
%fprintf(' %f \n', theta5);
%fprintf('\n');

%fprintf('Theta6 computed from gradient descent: \n');
%fprintf(' %f \n', theta6);
%fprintf('\n');
...
price = [1 (1650-mu(1))/sigma(1) (3-mu(2))/sigma(2)]*theta3; % You should change this
